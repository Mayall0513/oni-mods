...
namespace Blueprints {
    public sealed class Integration : KMod.UserMod2 {
        public override void OnLoad(Harmony harmony) {
            ...
            BlueprintsAssets.BLUEPRINTS_USE_RENAME = new PActionManager().CreateAction("Blueprints.use.rename", "Rename Blueprint", new PKeyBinding(KKeyCode.End, Modifier.None));
            BlueprintsAssets.BLUEPRINTS_USE_CYCLEFOLDERS_NEXT = new PActionManager().CreateAction("Blueprints.use.cyclefolders.next", "Next Folder", new PKeyBinding(KKeyCode.UpArrow, Modifier.None));
    ...
    public static class ToolMenu_OnPrefabInit {
        ...
        {
            if (Assets.Sprites.ContainsKey(BlueprintsAssets.BLUEPRINTS_CREATE_ICON_SPRITE.name))
                Assets.Sprites.Remove(BlueprintsAssets.BLUEPRINTS_CREATE_ICON_SPRITE.name);
            Assets.Sprites.Add(BlueprintsAssets.BLUEPRINTS_CREATE_ICON_SPRITE.name, BlueprintsAssets.BLUEPRINTS_CREATE_ICON_SPRITE);

            if (Assets.Sprites.ContainsKey(BlueprintsAssets.BLUEPRINTS_USE_ICON_SPRITE.name))
                Assets.Sprites.Remove(BlueprintsAssets.BLUEPRINTS_USE_ICON_SPRITE.name);
            Assets.Sprites.Add(BlueprintsAssets.BLUEPRINTS_USE_ICON_SPRITE.name, BlueprintsAssets.BLUEPRINTS_USE_ICON_SPRITE);

            if (Assets.Sprites.ContainsKey(BlueprintsAssets.BLUEPRINTS_SNAPSHOT_ICON_SPRITE.name))
                Assets.Sprites.Remove(BlueprintsAssets.BLUEPRINTS_SNAPSHOT_ICON_SPRITE.name);
